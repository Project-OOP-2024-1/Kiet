        ...
        if (scenarioState==0){
            ...
            switch (messageCounter){
                ...
                case 4:
                    ...
                    break;
                case 5:
                    currentDialogue="                   Mission Procession\n"+countItems.get("Mushroom")+"/8 mushrooms";
                ...
                case 7:
                    ...
                    break;
                case 8:
                    currentDialogue="                   Mission Procession\n"+countItems.get("Portion")+"/3 full portion";
                    if (countItems.get("Portion")>=3){
                        countItems.put("Portion",0);
                    }
                    else {
                        messageCounter=7;
                ...
                case 10:
                    ...
                    gp.player.inventory.add(object);
                    gp.player.inventory.add(object);
                    addMessage("Receive cure bottle");
                    break;
                case 11:
                    messageCounter=0;
                    scenarioState=4;
